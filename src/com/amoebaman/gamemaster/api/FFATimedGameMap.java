...
public class FFATimedGameMap extends FFAGameMap {
	
	public int timeLimitMinutes;
	
	public FFATimedGameMap(String name, World world){
		super(name, world);
		denullify();
	}
	
	public FFATimedGameMap(String name, ConfigurationSection yaml){
		super(name, yaml);
		if(yaml != null)
	...
	public FFATimedGameMap(File file){
